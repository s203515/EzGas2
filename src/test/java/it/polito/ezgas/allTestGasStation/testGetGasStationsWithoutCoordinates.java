...
class TestGetGasStationsWithoutCoordinates {
	...
	@Test
	void testGetGasStationsWithCoordinates1() throws InvalidGasTypeException, GPSDataException{
		...
		result = gasService.getGasStationsWithoutCoordinates( "diesel", "Enjoy");
	...
	@Test
	void testGetGasStationsWithCoordinates2() throws InvalidGasTypeException, GPSDataException{
	...
	@Test
	void testGetGasStationsWithCoordinates3() throws InvalidGasTypeException, GPSDataException{
		GasStationDto gsDto = new GasStationDto(1,"shell","via test",true,true,true,true,true,true,"Enjoy",0,0,1.0,1.1,1.2,1.3,1.4,1.5,1,"12:10",1);
		GasStation gs = new GasStation("eni","via test",true,false,false,false,false,false,"Enjoy",0,0,1.0,1.1,1.2,1.3,1.4,1.5,1,"12:10",1);
		GasStation gs2 = new GasStation("shell","via test",true,true,true,true,true,true,"Enjoy",0,0,1.0,1.1,1.2,1.3,1.4,1.5,1,"12:10",1);
	...
	@Test
	void testGetGasStationsWithCoordinates4() throws InvalidGasTypeException, GPSDataException{
		...
		when(gasStationRepository.findAll()).thenReturn(input);
		result = gasService.getGasStationsWithoutCoordinates( "super", "Car2Go");
		assertEquals(result.get(0).getGasStationName(),			gsDto.getGasStationName());
		assertEquals(result.get(0).getGasStationAddress(),		gsDto.getGasStationAddress());
		assertEquals(result.get(0).getHasDiesel(),				gsDto.getHasDiesel());
		assertEquals(result.get(0).getHasGas(),					gsDto.getHasGas());
	...
	@Test
	void testGetGasStationsWithCoordinates5() throws InvalidGasTypeException, GPSDataException{
	...
	@Test
	void testGetGasStationsWithCoordinates6() throws InvalidGasTypeException, GPSDataException{
		GasStationDto gsDto = new GasStationDto(1,"shell","via test",true,true,true,true,true,true,"Car2Go",0,0,1.0,1.1,1.2,1.3,1.4,1.5,1,"12:10",1);
		GasStation gs = new GasStation("eni","via test",true,true,false,false,false,false,"null",0,0,1.0,1.1,1.2,1.3,1.4,1.5,1,"12:10",1);
		GasStation gs2 = new GasStation("shell","via test",true,true,true,true,true,true,"Car2Go",0,0,1.0,1.1,1.2,1.3,1.4,1.5,1,"12:10",1);
	...
	@Test
	void testGetGasStationsWithCoordinates7() throws InvalidGasTypeException, GPSDataException{
		GasStationDto gsDto = new GasStationDto(1,"shell","via test",true,true,true,true,true,true,"Car2Go",0,0,1.0,1.1,1.2,1.3,1.4,1.5,1,"12:10",1);
		...
		input.add(gs2);
		when(gasStationRepository.findAll()).thenReturn(input);
		result = gasService.getGasStationsWithoutCoordinates("superplus", "null");
		assertEquals(result.get(0).getGasStationName(),			gsDto.getGasStationName());
		assertEquals(result.get(0).getGasStationAddress(),		gsDto.getGasStationAddress());
		assertEquals(result.get(0).getHasDiesel(),				gsDto.getHasDiesel());
		assertEquals(result.get(0).getHasGas(),					gsDto.getHasGas());
	...
	@Test
	void testGetGasStationsWithCoordinates8() throws InvalidGasTypeException, GPSDataException{
		GasStationDto gsDto = new GasStationDto(1,"shell","via test",true,true,true,true,true,true,"Car2Go",0,0,1.0,1.1,1.2,1.3,1.4,1.5,1,"12:10",1);
		GasStation gs = new GasStation("shell","via test",false,false,false,false,false,false,"Car2Go",0,0,1.0,1.1,1.2,1.3,1.4,1.5,1,"12:10",1);
		GasStation gs2 = new GasStation("shell","via test",true,true,true,true,true,true,"Car2Go",0,0,1.0,1.1,1.2,1.3,1.4,1.5,1,"12:10",1);
		...
		input.add(gs2);
		when(gasStationRepository.findAll()).thenReturn(input);
		result = gasService.getGasStationsWithoutCoordinates("gas", "null");
		assertEquals(result.get(0).getGasStationName(),			gsDto.getGasStationName());
		assertEquals(result.get(0).getGasStationAddress(),		gsDto.getGasStationAddress());
		assertEquals(result.get(0).getHasDiesel(),				gsDto.getHasDiesel());
		assertEquals(result.get(0).getHasGas(),					gsDto.getHasGas());
	...
	@Test
	void testGetGasStationsWithCoordinates9() throws InvalidGasTypeException, GPSDataException{
		GasStationDto gsDto = new GasStationDto(1,"shell","via test",true,true,true,true,true,true,"Car2Go",0,0,1.0,1.1,1.2,1.3,1.4,1.5,1,"12:10",1);
		GasStation gs = new GasStation("shell","via test",false,false,false,false,false,false,"Car2Go",0,0,1.0,1.1,1.2,1.3,1.4,1.5,1,"12:10",1);
		GasStation gs2 = new GasStation("shell","via test",true,true,true,true,true,true,"Car2Go",0,0,1.0,1.1,1.2,1.3,1.4,1.5,1,"12:10",1);
		...
		input.add(gs2);
		when(gasStationRepository.findAll()).thenReturn(input);
		result = gasService.getGasStationsWithoutCoordinates("methane", "null");
		assertEquals(result.get(0).getGasStationName(),			gsDto.getGasStationName());
		assertEquals(result.get(0).getGasStationAddress(),		gsDto.getGasStationAddress());
		assertEquals(result.get(0).getHasDiesel(),				gsDto.getHasDiesel());
		assertEquals(result.get(0).getHasGas(),					gsDto.getHasGas());
	...
	void testGetGasStationsWithCoordinates13() throws InvalidGasTypeException, GPSDataException{
		...
		input.add(gs2);
		when(gasStationRepository.findAll()).thenReturn(input);
		result = gasService.getGasStationsWithoutCoordinates("premiumdiesel", "null");
		assertEquals(result.get(0).getGasStationName(),			gsDto.getGasStationName());
		assertEquals(result.get(0).getGasStationAddress(),		gsDto.getGasStationAddress());
		assertEquals(result.get(0).getHasDiesel(),				gsDto.getHasDiesel());
		assertEquals(result.get(0).getHasGas(),					gsDto.getHasGas());
	...
	void testGetGasStationsWithCoordinates11() throws InvalidGasTypeException, GPSDataException{
		assertThrows(exception.InvalidGasTypeException.class, ()-> gasService.getGasStationsWithoutCoordinates( "benzina", "abc"));
		
	}
	@Test
	void testGetGasStationsWithCoordinates12() throws InvalidGasTypeException, GPSDataException{
		
		result = gasService.getGasStationsWithoutCoordinates( "abc", null );
